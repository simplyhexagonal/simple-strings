var SimpleStrings = (() => {
  ...
  // node_modules/.pnpm/@simplyhexagonal+multi-replace@1.0.4/node_modules/@simplyhexagonal/multi-replace/dist/multi-replace.js
  var require_multi_replace = __commonJS({
    "node_modules/.pnpm/@simplyhexagonal+multi-replace@1.0.4/node_modules/@simplyhexagonal/multi-replace/dist/multi-replace.js"(exports, module) {
      var MultiReplace = (() => {
        ...
        var multiReplaceSync2 = (content, replacePatterns) => replacePatterns.reduce((a, b) => a.replace(...b), content);
        return src_exports2;
      })();
      typeof module != "undefined" && (module.exports = MultiReplace), typeof window != "undefined" && (MultiReplace = MultiReplace);
    }
  });
  ...
  var removeDiacritics = (string, limitLength = true) => {
    if (limitLength && string.length > 2048) {
      throw "removeDiacritics: string exceeds 2048 character limit!";
    }
    return (0, import_multi_replace.multiReplaceSync)(string, diacriticReplacePatterns);
  };
  var makeUrlSafe = (string) => {
...
//# sourceMappingURL=simple-strings.js.map
'undefined'!=typeof module&&(module.exports=SimpleStrings),'undefined'!=typeof window&&(SimpleStrings=SimpleStrings);